...
The difference from this code and `diskbb.py` is that
the code is optimized to work in the TensorFlow operation.
For example, original for loop has been convered to use
TensorFlow coutnerparts (conversion is not always the same
function, depending on the context where the loop is used).
